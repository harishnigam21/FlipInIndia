<?php  
   ...
   $sessData=userAccess();
    $title = "Add Residential's Portfolios";
    $dir="portfolios";
    $dirFile ="residential";
    ...
    if(isset($_POST['AddNEWComIMG']))
         {
          ...
          if($post_photo != '')
            {      
              ...
              imagejpeg($tmp_min,'../assets/img/portfolio/residential/'.$newname,100);
              }
            else
              {
          ...
          $status=addPortfolio($conn,$main,$sub,$newname,"residential");
            if($status=="0")
            {
         ...
         if(isset($_POST['updateTEST']))
        {
          ...
          $data=AllPortfolio($conn,"residential");
          ...
          <section class="wrapper">
            ...
            <div class="row top2">
              ...
              <div class="col-md-12">
                ...
                <h2>Residential's Portfolios Panel </h2>
                <hr class="hr-div">
