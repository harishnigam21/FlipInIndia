<?php  
   ...
   $sessData=userAccess();
    $title = "Add commercial's portfolios";
    $dir="portfolios";
    $dirFile ="commercial";
    ...
    if(isset($_POST['AddNEWComIMG']))
         {
          ...
          if($post_photo != '')
            {      
              ...
              $target_file_pro = constant("PORT_COM").$newname; 
              if (file_exists($target_file_pro)) 
                {
                  $uploadOK = 0;
                  $url=constant("PORT_COM").$target_file;
                }
              else
                {
                  $uploadOK = 1;
              ...
              imagejpeg($tmp_min,'../assets/img/portfolio/commercial/'.$newname,100);
              }
            else
              {
          ...
          $status=addPortfolio($conn,$main,$sub,$newname,"commercial");
            if($status=="0")
            {
         ...
         if(isset($_POST['updateTEST']))
        {
          ...
          $data=AllPortfolio($conn,"commercial");
    ...
    <!-- MAIN CONTENT -->
      ...
      <section id="main-content">
          <section class="wrapper">
            <div class="row top2">
              <div class="col-md-12">
                <h2>Commercial's portfolios Panel </h2>
                <hr class="hr-div">
              </div>
            </div>
            <div class="row dtrow">
