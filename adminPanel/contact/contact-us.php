...
require_once(realpath(dirname(__FILE__)."/../config/sessionManager.php"));
   ...
   $sessData=userAccess();
    $title = "All Product".$sessData['loggedAs']; 
    $dir="contact"; 
    $dirFile ="contact-us"; 
      include_once("../structure/header.php");
      include_once("../structure/leftBar.php");
      require_once(realpath(dirname(__FILE__)."/../config/database.php"));
      require_once(realpath(dirname(__FILE__)."/../models/adminModel/contactModel.php"));
     
      $data= allContent($conn);
?>
